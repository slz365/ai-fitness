...
1. 首次打开输入访问密码（**默认密码 `123456`**，进入后可在「我的」页修改）
2. 填写身体数据、目标和训练动作
3. 在「计划」页让 AI 生成训练计划，可随时提建议调整
4. 每天在「记录」页记录饮食和运动
5. 记录后点「AI 评估今天」获取达标判断和建议
6. 在「我的」页查看体重/力量曲线和打卡日历

## ⚠️ 注意

- 数据存储在浏览器本地，清除浏览器数据或更换设备会导致数据丢失
- 如需多设备同步，需接入云端数据库
- **重要**：本网站部署在 Vercel（境外服务器），国内（尤其是手机端）访问可能不稳定或打不开，**使用本网站需要梯子（VPN/代理）**
